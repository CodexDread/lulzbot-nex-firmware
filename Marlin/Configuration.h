...
#define STRING_CONFIG_H_AUTHOR "Imperium Solutions" // Who made the changes.
#define CUSTOM_VERSION_FILE Version.h // Path from the root directory (no quotes)
#define LULZBOT_FW_VERSION "0.0.01b"
...
#define MOTHERBOARD BOARD_RAMBO //Taz6 Default board
...
// UNIVERSAL TOOLHEADS
#if defined(LULZBOT_UNIVERSAL_TOOLHEAD) || ANY(TOOLHEAD_M175,TOOLHEAD_H175,TOOLHEAD_SL_SE_HE,TOOLHEAD_NEX_E1-v1)
...
#elif defined(TOOLHEAD_NEX_i1)
  #undef LULZBOT_M115_EXTRUDER_TYPE
  #define LULZBOT_M115_EXTRUDER_TYPE       "NEX i1"
  #define LULZBOT_TOOLHEAD_X_MAX_ADJ             0
  #define LULZBOT_TOOLHEAD_X_MIN_ADJ             0
  #define LULZBOT_TOOLHEAD_Y_MAX_ADJ             0
  #define LULZBOT_TOOLHEAD_Y_MIN_ADJ             0
